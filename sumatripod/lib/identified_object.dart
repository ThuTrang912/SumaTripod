...
//     try {
//       _interpreter =
//           await Interpreter.fromAsset('models/yolo11n_float32.tflite');
//     } catch (e) {
...
//           .build()
//           .process(TensorImage.fromImage(await _convertToImage(_imageBytes)));

//       var outputBuffer =
//           TensorBuffer.createFixedSize(<int>[1, 25200, 85], TfLiteType.float32);
//       _interpreter.run(inputImage.buffer, outputBuffer.buffer);

//       // Parse the output
//       var detections = _parseDetections(outputBuffer);
...
//   List<Map<String, dynamic>> _parseDetections(TensorBuffer outputBuffer) {
//     // Parse the output buffer to extract detection information
//     // This is a placeholder implementation and should be replaced with actual parsing logic
//     List<Map<String, dynamic>> detections = [];
//     for (int i = 0; i < outputBuffer.shape[1]; i++) {
//       var detection =
//           outputBuffer.getDoubleList().sublist(i * 85, (i + 1) * 85);
//       if (detection[4] > 0.5) {
//         // Confidence threshold
//         detections.add({
//           'name': 'object', // Replace with actual class name if available
//           'x': detection[0],
//           'y': detection[1],
//           'width': detection[2],
//           'height': detection[3],
...
//   Future<image.Image> _convertToImage(Uint8List bytes) async {
